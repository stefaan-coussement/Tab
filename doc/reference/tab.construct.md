...
---
### Tab.construct( delegateTab, filter = passThroughFilter ) » newDelegatingTab
...
*   passThroughFilter
    ...
    ~~~~javascript
    passThroughFilter = {
        onUpdate: Tab.prototype.update,
        onThrow: Tab.prototype.throw,
        onFulfilled: Tab.prototype.fulfill,
        onRejected: Tab.prototype.reject
    };
    ~~~~ 
...
<br /> Back to [Top] | [Topics] | [Reference] / [Tab Constructor Methods][ref-tab-constructor-methods] <br />
