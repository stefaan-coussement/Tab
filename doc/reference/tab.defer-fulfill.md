...
Create a function that updates the value of a given tab and silently blocks any further updates.
...
parameters:
*   **target** : *[object Tab]*  
    the tab that will get updated with the arguments of the new function, and that will be silently blocking any further updates, when that new function is being called.

returns:
*   **newFunction** : *function*  
    a newly constructed function that uses a given tab to store this new function's arguments, silently blocking any further updates.
