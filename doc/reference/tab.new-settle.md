...
Create a new tab and silently block any further updates.
...
> :bulb:
> ````
> Tab.newSettle() ~ Tab.construct().settle()
> ````

returns:
*   **newTab** : *[object Tab]*  
    a newly constructed Tab object, silently blocking any further updates.
