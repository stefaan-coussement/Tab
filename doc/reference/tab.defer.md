...
this is typically used to avoid that the returned value from a deferred function is used to update the target tab of the deferred function.
...
function defer(target, processor) {
    var target = (target != null) ? Tab(target) : null;
